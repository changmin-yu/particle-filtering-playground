...
from bion_rectangle.utils.zipPickle import save, load

from bion_rectangle.utils.argsutil import dict2fname, kwdef, fullpath2hash
...
class Cache(object):
    ...
    def get(
        ...
        def get_subitem(subkey):
            import torch
            from bion_rectangle.utils.numpytorch import get_default_gpu_device
